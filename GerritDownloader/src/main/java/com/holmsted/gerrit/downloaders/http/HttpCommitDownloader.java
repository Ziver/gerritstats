 ...
 */
public class HttpCommitDownloader extends GerritCommitDownloader {
    private int startOffset;
    private boolean hasMoreChanges = true;
    private int rowCount = 0;


    public HttpCommitDownloader(@Nonnull GerritServer gerritServer, GerritVersion gerritVersion) {
